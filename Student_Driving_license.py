...
label_id=label(root,text=["19827198349"])
label_name=label(root,text=["winnie the pooh"])
label_dob=label(root,text=["21 August 1921"])
label_pin=label(root,text=["451478"])
label_address=label(root,text=["Disney Land,Hong Kong"])
label_label_vehicle_type(root,text=["Two Four"])

# Define the function

    
    
button1 = Button(root,text["show my driving liesence"])
